<div class="row">
    <div class="col-md-10">
        ...
        <x-form-card title="Social Media">
            <form wire:submit.prevent="saveSettings">
                <x-form-group>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="facebook" id="facebook" wire:model="facebook">
                    </div>
                    @error('facebook')
                ...
                <x-form-group>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="instagram" id="instagram" wire:model="instagram">
                    </div>
                    @error('instagram')
                    <small class="text-danger">{{$message}}</small>
                    @enderror
                ...
                <x-form-group>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="linkedin" id="linkedin" wire:model="linkedin">
                    </div>
                    @error('linkedin')
                    <small class="text-danger">{{$message}}</small>
                    @enderror
                ...
                <x-form-group>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="tiktok" id="tiktok" wire:model="tiktok">
                    </div>
                    @error('tiktok')
                    <small class="text-danger">{{$message}}</small>
                    @enderror
