<div class="row">
    <div class="col-md-8">
        <h6 class="text-uppercase text-secondary">Themes</h6>
        <hr>
        <div class="card">
                ...
                <div class="switcher-body">
                    ...
                    <div class="header-colors-indigators">
                        <div class="row row-cols-auto g-3">
                            ...
                            <div class="col">
                                <div class="indigator reset {{ !$preferences['header'] ? 'active' : '' }}" title="Reset"
                                    wire:click="changeHeader(null)"></div>
                            </div>
                        </div>
                    </div>
