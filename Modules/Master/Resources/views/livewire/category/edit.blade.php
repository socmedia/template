<div>
    ...
    <h6 class="text-uppercase text-secondary">Edit Kategori</h6>
    <hr>
                    ...
                    <div class="card-body p-4">
                        <div class="form-group row">
                            <div class="col-md-6 mb-3 mb-md-0">
                                ...
                                <input type="text" class="form-control" list="table_references"
                                    name="table_reference" id="table_reference" wire:model.lazy="table_reference">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 mb-3 mb-md-0">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="with" id="with"
                                        wire:model="with" value="">
                ...
                <div class="col-md-3 mb-3 mb-md-0">
                    <ul class="list-group sidebar">
                        <li class="list-group-item d-flex">
                            ...
                            <div>
                                <p>Gambar Kategori</p>
                                <small>Usahakan ukuran file tidak lebih dari 50kb, dengan ukuran 200x200 dan dengan
                                    rasio
                                    1:1.</small>
                            </div>
                        </li>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="form-group row">
                                <div class="col-6">
                                    <livewire:image-upload :images="$image" :oldImages="$oldImage" height="130px" />
