                ...
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control bg-light">{{ title(unslug(substr($key, 6))) }}</div>
                        </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="form-group row">
                            <div class="col-md-4 mb-3 mb-md-0">
                                ...
                                <div class="form-control bg-light">{{ $group }}</div>
                            </div>
                            <div class="col-md-4 mb-3 mb-md-0">
                                <label for="group">Tipe Value</label>
                                <div class="form-control bg-light">{{ title($type) }}</div>
                            </div>
                            <div class="col-md-4 mb-3 mb-md-0">
                                <label for="form_type">Jenis Form</label>
                                <div class="form-control bg-light">{{ $form_type }}</div>
                            </div>
                        </div>
