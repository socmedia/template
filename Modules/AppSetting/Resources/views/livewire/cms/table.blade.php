<div>
    ...
    <h6 class="text-uppercase text-secondary">Daftar Setting CMS</h6>
    <hr>
                ...
                <x-table.row>
                    ...
                    <x-table.cell width="70%">
                        ...
                        <div class="collapse" id="seo-{{ $loop->iteration }}">
                            ...
                            @if ($setting->type == 'string' && $setting->form_type != 'editor')
                                <p class="my-2">
                                    {{ $setting->value }}</p>
                            @elseif ($setting->type == 'string' && $setting->form_type == 'editor')
                                {!! $setting->value !!}
                            @elseif ($setting->type == 'image')
                                <img src="{{ $setting->value }}" height="100" alt="">
                            @endif
                    ...
                    <x-table.cell>
                        <div class="btn-group" role="group">
                            <x-action-button href="{{ route('adm.cms.edit', $setting->id) }}">
