    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <x-breadcrumb pageTitle="Content Management System">
                <x-slot name="link">
                    <x-breadcrumb.link href="{{ route('adm.cms.index') }}" pageTitle="Content Management System" />
                    <x-breadcrumb.link active="true" pageTitle="Edit" />
                </x-slot>
                <x-slot name="button">
                    <x-button.back href="{{ route('adm.cms.index') }}" />
                </x-slot>
            </x-breadcrumb>

            <livewire:appsetting::cms.edit :setting="$setting" />
        </div>
    </div>
@endsection
