                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="progress" style="height: 5px;">
                                <div class="progress-bar bg-gradient-bloody" role="progressbar" style="width: 50%">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="progress" style="height: 5px;">
                                <div class="progress-bar bg-gradient-scooter" role="progressbar" style="width: 65%">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="progress" style="height: 5px;">
                                <div class="progress-bar bg-gradient-blooker" role="progressbar" style="width: 85%">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="progress" style="height: 5px;">
                                <div class="progress-bar bg-gradient-quepal" role="progressbar" style="width: 75%">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-0">
                            ...
                            <div class="progress" style="height: 5px;">
                                <div class="progress-bar bg-gradient-cosmic" role="progressbar" style="width: 55%">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table align-middle mb-0">
                        ...
                        <tbody>
                            <tr>
                                <td>Iphone 5</td>
                                <td><img src="{{ asset('assets/app/images/products/01.png')  }}" class="product-img-2"
                                        alt="product img">
                                </td>
                                <td>#9405822</td>
                            ...
                            <tr>
                                <td>Earphone GL</td>
                                <td><img src="{{ asset('assets/app/images/products/02.png')  }}" class="product-img-2"
                                        alt="product img"></td>
                                <td>#8304620</td>
                            ...
                            <tr>
                                ...
                                <td><img src="{{ asset('assets/app/images/products/03.png')  }}" class="product-img-2"
                                        alt="product img"></td>
                                <td>#4736890</td>
                            ...
                            <tr>
                                <td>Clasic Shoes</td>
                                <td><img src="{{ asset('assets/app/images/products/04.png')  }}" class="product-img-2"
                                        alt="product img"></td>
                                <td>#8543765</td>
                                <td><span class="badge bg-gradient-quepal text-white shadow-sm w-100">Paid</span></td>
                                <td>$1200.00</td>
                            ...
                            <tr>
                                <td>Sitting Chair</td>
                                <td><img src="{{ asset('assets/app/images/products/06.png')  }}" class="product-img-2"
                                        alt="product img"></td>
                                <td>#9629240</td>
                                <td><span class="badge bg-gradient-blooker text-white shadow-sm w-100">Pending</span>
                                </td>
                            ...
                            <tr>
                                <td>Hand Watch</td>
                                <td><img src="{{ asset('assets/app/images/products/05.png')  }}" class="product-img-2"
                                        alt="product img"></td>
                                <td>#8506790</td>
                                <td><span class="badge bg-gradient-bloody text-white shadow-sm w-100">Failed</span></td>
                                <td>$1800.00</td>
