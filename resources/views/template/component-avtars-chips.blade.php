    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <hr>
                <div class="chip">
                    <img src="{{ asset('assets/app/images/avatars/avatar-1.png') }}" alt="Contact Person">John Doe</div>
                <div class="chip">
                    <img src="{{ asset('assets/app/images/avatars/avatar-2.png') }}" alt="Contact Person">Jessica Doe
                </div>
                <div class="chip">
                    <img src="{{ asset('assets/app/images/avatars/avatar-3.png') }}" alt="Contact Person">Michele Powa
                </div>
                <div class="chip">
                    <img src="{{ asset('assets/app/images/avatars/avatar-4.png') }}" alt="Contact Person">Clark Natela
                </div>
                <div class="chip">
                    <img src="{{ asset('assets/app/images/avatars/avatar-5.png') }}" alt="Contact Person">Anantu Painda
                    <span class="closebtn" onclick="this.parentElement.style.display='none'">×</span>
                </div>
                <div class="chip">
                    <img src="{{ asset('assets/app/images/avatars/avatar-6.png') }}" alt="Contact Person">Tiger Xink
                    <span class="closebtn" onclick="this.parentElement.style.display='none'">×</span>
                </div>
                <div class="chip">
                    <img src="{{ asset('assets/app/images/avatars/avatar-7.png') }}" alt="Contact Person">Salena Chain
                    <span class="closebtn" onclick="this.parentElement.style.display='none'">×</span>
                </div>
                <hr>
                <div class="chip">John Doe <span class="closebtn"
