        ...
        <div class="chat-wrapper my-5">
                ...
                <div class="chat-sidebar-header">
                    <div class="d-flex align-items-center">
                        <div class="chat-user-online">
                            <img src="{{ asset('assets/app/images/avatars/avatar-1.png') }}" width="45" height="45"
                            ...
                            <div class="chat-list">
                                <div class="list-group list-group-flush">
                                    ...
                                    <a href="javascript:;" class="list-group-item">
                                        <div class="d-flex">
                                            <div class="chat-user-online">
                                                <img src="{{ asset('assets/app/images/avatars/avatar-11.png') }}"
                                                    width="42" height="42" class="rounded-circle" alt="" />
                                            </div>
                                            <div class="flex-grow-1 ms-2">
            ...
            <div class="chat-content">
                <div class="chat-content-leftside">
                    <div class="d-flex">
                        <img src="{{ asset('assets/app/images/avatars/avatar-3.png') }}" width="48" height="48"
                            class="rounded-circle" alt="" />
                        <div class="flex-grow-1 ms-2">
                ...
                <div class="chat-content-rightside">
                    <div class="d-flex">
                        <div class="flex-grow-1 me-2">
                            ...
                            <p class="chat-right-msg">i purchased Rocker admin template from themeforest. it is very
