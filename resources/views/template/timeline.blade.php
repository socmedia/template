                        ...
                        <div class="col py-2">
                            <div class="card radius-15">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Welcome to the campus, introduction and get started with the
                                        tour.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card border-primary shadow radius-15">
                                <div class="card-body">
                                    ...
                                    <button class="btn btn-sm btn-outline-secondary" type="button"
                                        data-bs-target="#t2_details" data-bs-toggle="collapse">Show Details ▼</button>
                            ...
                            <div class="card border-primary shadow radius-15">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Sign-up for the lessons and speakers that coincide with your
                                        course syllabus. Meet and greet with instructors.</p>
                                    <button class="btn btn-sm btn-outline-secondary" type="button"
                                        data-bs-target="#t22_details" data-bs-toggle="collapse">Show Details ▼</button>
