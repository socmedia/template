...
<link href="{{ asset('assets/app/plugins/highcharts/css/highcharts-white.css') }}" rel="stylesheet" />
@endpush
...
<script src="{{ asset('assets/app/plugins/vectormap/jquery-jvectormap-world-mill-en.js') }}">
</script>
<!-- highcharts js -->
<script src="{{ asset('assets/app/plugins/highcharts/js/highcharts.js') }}">
</script>
<script src="{{ asset('assets/app/plugins/apexcharts-bundle/js/apexcharts.min.js') }}">
</script>
<script src="{{ asset('assets/app/js/dashboard-analytics.js') }}"></script>
<script>
