        ...
        <div class="row">
            <div class="col-12 col-lg-9 mx-auto">
                ...
                <div class="card radius-10">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('assets/app/images/avatars/avatar-1.png') }}"
                ...
                <div class="card radius-10">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('assets/app/images/avatars/avatar-2.png') }}"
                                class="rounded-circle p-1 border" width="90" height="90" alt="...">
                            <div class="flex-grow-1 ms-3">
                                <h5 class="mt-0">Media heading</h5>
                                ...
                                <div class="d-flex align-items-center mt-3">
                                    <a class="mr-3" href="#">
                                        <img src="{{ asset('assets/app/images/avatars/avatar-3.png') }}"
                                            class=" rounded-circle p-1 border" width="90" height="90" alt="...">
                                    </a>
                                    <div class="flex-grow-1 ms-3">
                                        <h5 class="mt-0">Media heading</h5>
                ...
                <div class="card radius-10">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('assets/app/images/avatars/avatar-4.png') }}"
                                class="align-self-start rounded-circle p-1 border" width="90" height="90" alt="...">
                            <div class="flex-grow-1 ms-3">
                        ...
                        <hr>
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('assets/app/images/avatars/avatar-5.png') }}"
                                class="align-self-center rounded-circle p-1 border" width="90" height="90" alt="...">
                            <div class="flex-grow-1 ms-3">
                        ...
                        <hr>
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('assets/app/images/avatars/avatar-6.png') }}"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <img src="{{ asset('assets/app/images/avatars/avatar-7.png') }}"
                                class="ml-3 rounded-circle p-1 border" width="90" height="90" alt="...">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled">
                            <li class="d-flex align-items-center border-bottom pb-2">
                                <img src="{{ asset('assets/app/images/avatars/avatar-8.png') }}"
                                    class="rounded-circle p-1 border" width="90" height="90" alt="...">
                                <div class="flex-grow-1 ms-3">
                            ...
                            <li class="d-flex align-items-center my-4 border-bottom pb-2">
                                <img src="{{ asset('assets/app/images/avatars/avatar-9.png') }}"
                                    class="rounded-circle p-1 border" width="90" height="90" alt="...">
                                <div class="flex-grow-1 ms-3">
                                    <h5 class="mt-0 mb-1">List-based media object</h5>
                                    Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante
                            ...
                            <li class="d-flex align-items-center">
                                <img src="{{ asset('assets/app/images/avatars/avatar-10.png') }}"
                                    class="rounded-circle p-1 border" width="90" height="90" alt="...">
                                <div class="flex-grow-1 ms-3">
                                    <h5 class="mt-0 mb-1">List-based media object</h5>
                                    Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante
