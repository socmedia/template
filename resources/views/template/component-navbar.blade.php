                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-primary rounded">
                    <div class="container-fluid"> <a class="navbar-brand" href="#">Navbar</a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent2">
                            ...
                            <form class="d-flex">
                                <button class="btn btn-light px-4" type="submit"><i class='bx bx-cart'></i> Buy
                                    Now</button>
                            </form>
                        </div>
                    </div>
                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-danger rounded">
                    <div class="container-fluid"> <a class="navbar-brand" href="#">Navbar</a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent3">
                            ...
                            <form class="d-flex">
                                <button class="btn btn-dark me-3 radius-30 px-4" type="submit"><i
                                        class='bx bx-lock'></i> Login</button>
                                <button class="btn btn-light radius-30 px-4" type="submit"><i class='bx bx-user'></i>
                                    Register</button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid"> <a class="navbar-brand" href="#">Navbar</a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent4">
                            ...
                            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                                <li class="nav-item"> <a class="nav-link" href="#"><i
                                            class='bx bxl-facebook-square font-22 text-white'></i></a>
                                </li>
                                <li class="nav-item"> <a class="nav-link" href="#"><i
                                            class='bx bxl-twitter font-22 text-white'></i></a>
                                </li>
                                <li class="nav-item"> <a class="nav-link" href="#"><i
                                            class='bx bxl-linkedin-square font-22 text-white'></i></a>
                                </li>
                                <li class="nav-item"> <a class="nav-link" href="#"><i
                                            class='bx bxl-youtube font-22 text-white'></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
