        ...
        <div class="card">
            <div class="card-body">
                <div class="row row-cols-auto row-cols-1 row-cols-md-2 row-cols-lg-4 g-3">
                    ...
                    <div class="col">
                        <div class="p-4 border border-3 border-primary text-center rounded bg-light">.border-primary
                        </div>
                    </div>
                    <div class="col">
                    ...
                    <div class="col">
                        <div class="p-4 border border-3 border-success text-center rounded bg-light">.border-success
                        </div>
                    </div>
                    <div class="col">
                    ...
                    <div class="col">
                        <div class="p-4 border border-3 border-warning text-center rounded bg-light">.border-warning
                        </div>
                    </div>
                    <div class="col">
