                    ...
                    <div class="card mb-5 mb-lg-0">
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item"><i class='bx bx-check me-2 font-18'></i>Unlimited Public
                                    Projects</li>
                                <li class="list-group-item"><i class='bx bx-check me-2 font-18'></i>Community Access
                                </li>
                                <li class="list-group-item text-secondary"><i class='bx bx-x me-2 font-18'></i>Unlimited
                                    Private Projects</li>
                                <li class="list-group-item text-secondary"><i class='bx bx-x me-2 font-18'></i>Dedicated
                                    Phone Support</li>
                                <li class="list-group-item text-secondary"><i class='bx bx-x me-2 font-18'></i>Free
                                    Subdomain</li>
                                <li class="list-group-item text-secondary"><i class='bx bx-x me-2 font-18'></i>Monthly
                                    Status Reports</li>
                            </ul>
                    ...
                    <div class="card mb-5 mb-lg-0">
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item"><i class='bx bx-check me-2 font-18'></i>Unlimited Private
                                    Projects</li>
                                <li class="list-group-item"><i class='bx bx-check me-2 font-18'></i>Dedicated Phone
                                    Support</li>
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item"><i class='bx bx-check me-2 font-18'></i>Dedicated Phone
                                    Support</li>
                                <li class="list-group-item"><i class='bx bx-check me-2 font-18'></i>Free Subdomain</li>
                                <li class="list-group-item"><i class='bx bx-check me-2 font-18'></i>Monthly Status
                                    Reports</li>
                            </ul>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item bg-transparent"><i
                                        class='bx bx-check me-2 font-18'></i>Single User</li>
                                <li class="list-group-item bg-transparent"><i class='bx bx-check me-2 font-18'></i>5GB
                                    Storage</li>
                                <li class="list-group-item bg-transparent"><i
                                        class='bx bx-check me-2 font-18'></i>Unlimited Public Projects</li>
                                <li class="list-group-item bg-transparent"><i
                                        class='bx bx-check me-2 font-18'></i>Community Access</li>
                                <li class="list-group-item bg-transparent"><i class='bx bx-x me-2 font-18'></i>Unlimited
                                    Private Projects</li>
                                <li class="list-group-item bg-transparent"><i class='bx bx-x me-2 font-18'></i>Dedicated
                                    Phone Support</li>
                                <li class="list-group-item bg-transparent"><i class='bx bx-x me-2 font-18'></i>Free
                                    Subdomain</li>
                                <li class="list-group-item bg-transparent"><i class='bx bx-x me-2 font-18'></i>Monthly
                                    Status Reports</li>
                            </ul>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item bg-transparent text-white"><i
                                        class='bx bx-check me-2 font-18'></i>Single User</li>
                                <li class="list-group-item bg-transparent text-white"><i
                                        class='bx bx-check me-2 font-18'></i>5GB Storage</li>
                                <li class="list-group-item bg-transparent text-white"><i
                                        class='bx bx-check me-2 font-18'></i>Unlimited Public Projects</li>
                                <li class="list-group-item bg-transparent text-white"><i
                                        class='bx bx-check me-2 font-18'></i>Community Access</li>
                                ...
                                <li class="list-group-item bg-transparent text-white"><i
                                        class='bx bx-check me-2 font-18'></i>Free Subdomain</li>
                                <li class="list-group-item bg-transparent text-white"><i
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item bg-transparent text-white"><i
                                        class='bx bx-check me-2 font-18'></i>Free Subdomain</li>
                                <li class="list-group-item bg-transparent text-white"><i
                                        class='bx bx-check me-2 font-18'></i>Monthly Status Reports</li>
                            </ul>
                            <div class="d-grid"> <a href="#" class="btn btn-white my-2 radius-30">Order Now</a>
                            </div>
                        </div>
