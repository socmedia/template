        ...
        <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-4">
                ...
                <div class="card radius-15">
                    <div class="card-body text-center">
                        <div class="p-4 border radius-15">
                            <img src="{{ asset('assets/app/images/avatars/avatar-1.png') }}" width="110" height="110"
            ...
            <div class="col">
                <div class="card radius-15">
                    <div class="card-body text-center">
                        <div class="p-4 border radius-15">
                            <img src="{{ asset('assets/app/images/avatars/avatar-2.png') }}" width="110" height="110"
                                class="rounded-circle shadow" alt="">
            ...
            <div class="col">
                <div class="card radius-15">
                    <div class="card-body text-center">
                        <div class="p-4 border radius-15">
                            <img src="{{ asset('assets/app/images/avatars/avatar-3.png') }}" width="110" height="110"
                                class="rounded-circle shadow" alt="">
            ...
            <div class="col">
                <div class="card radius-15">
                    <div class="card-body text-center">
                        <div class="p-4 border radius-15">
                            <img src="{{ asset('assets/app/images/avatars/avatar-4.png') }}" width="110" height="110"
                                class="rounded-circle shadow" alt="">
        ...
        <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-4">
                ...
                <div class="card radius-15 bg-primary">
                    <div class="card-body text-center">
                        <div class="p-4 radius-15">
                            <img src="{{ asset('assets/app/images/avatars/avatar-9.png') }}" width="110" height="110"
            ...
            <div class="col">
                <div class="card radius-15 bg-danger">
                    <div class="card-body text-center">
                        <div class="p-4 radius-15">
                            <img src="{{ asset('assets/app/images/avatars/avatar-15.png') }}" width="110" height="110"
                                class="rounded-circle shadow p-1 bg-white" alt="">
                            <h5 class="mb-0 mt-5 text-white">Pauline I. Bird</h5>
                            <p class="mb-3 text-white">Webdeveloper</p>
                            <div class="list-inline contacts-social mt-3 mb-3"> <a href="javascript:;"
            ...
            <div class="col">
                <div class="card radius-15 bg-warning">
                    <div class="card-body text-center">
                        <div class="p-4 radius-15">
                            <img src="{{ asset('assets/app/images/avatars/avatar-7.png') }}" width="110" height="110"
                                class="rounded-circle shadow p-1 bg-white" alt="">
            ...
            <div class="col">
                <div class="card radius-15 bg-info">
                    <div class="card-body text-center">
                        <div class="p-4 radius-15">
                            <img src="{{ asset('assets/app/images/avatars/avatar-8.png') }}" width="110" height="110"
                                class="rounded-circle shadow p-1 bg-white" alt="">
                            <h5 class="mb-0 mt-5 text-dark">Pauline I. Bird</h5>
                            <p class="mb-3 text-dark">Webdeveloper</p>
                            <div class="list-inline contacts-social mt-3 mb-3"> <a href="javascript:;"
