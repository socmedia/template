        ...
        <div class="email-wrapper my-5">
            <div class="email-sidebar">
                <div class="email-sidebar-header d-grid"> <a href="javascript:;"
                        class="btn btn-primary compose-mail-btn"><i class='bx bx-plus me-2'></i> Compose</a>
                </div>
                <div class="email-sidebar-content">
                    <div class="email-navigation">
                        <div class="list-group list-group-flush"> <a href="{{ url('app-emailbox') }}"
                                class="list-group-item active d-flex align-items-center"><i
                            ...
                            <div class="list-group-item email-hangout cursor-pointer border-top">
                                <div class="d-flex align-items-center">
                                    <div class="chat-user-online">
                                        <img src="{{ asset('assets/app/images/avatars/avatar-1.png') }}" width="42"
                    ...
                    <div class="email-list">
                        ...
                        <a href="{{ url('app-emailread') }}">
                            <div class="d-md-flex align-items-center email-message px-3 py-1">
                                ...
                                <div class="">
                                    <p class="mb-0">The point of using Lorem Ipsum is that it has a
                                        more-or-less
                                        normal...</p>
                                </div>
                                <div class="ms-auto">
                        ...
                        <a href="{{ url('app-emailread') }}">
                            <div class="d-md-flex align-items-center email-message px-3 py-1">
                                ...
                                <div class="">
                                    <p class="mb-0">Richard McClintock, a Latin professor at
                        ...
                        <a href="{{ url('app-emailread') }}">
                            <div class="d-md-flex align-items-center email-message px-3 py-1">
                                ...
                                <div class="">
                                    <p class="mb-0">If you are going to use a passage of Lorem Ipsum,
                                        you need to be
                                        sure there...</p>
                                </div>
                                <div class="ms-auto">
                        ...
                        <a href="{{ url('app-emailread') }}">
                            <div class="d-md-flex align-items-center email-message px-3 py-1">
                                ...
                                <div class="">
                                    <p class="mb-0">The standard chunk of Lorem Ipsum used since the
                                        1500s is reproduced
                                        below for...</p>
                                </div>
                                <div class="ms-auto">
                        ...
                        <a href="{{ url('app-emailread') }}">
                            <div class="d-md-flex align-items-center email-message px-3 py-1 bg-body">
                                ...
                                <div class="">
                                    <p class="mb-0">Bonorum et Malorum" by Cicero are also reproduced in
                                        their exact
                                        original form...</p>
                                </div>
                                <div class="ms-auto">
                        ...
                        <a href="{{ url('app-emailread') }}">
                            <div class="d-md-flex align-items-center email-message px-3 py-1 bg-body">
                                ...
                                <div class="">
                                    <p class="mb-0">But I must explain to you how all this mistaken idea
                                        of denouncing
                                        pleasure...</p>
                                </div>
                                <div class="ms-auto">
                        ...
                        <a href="{{ url('app-emailread') }}">
                            <div class="d-md-flex align-items-center email-message px-3 py-1">
                                ...
                                <div class="">
                                    <p class="mb-0">Ut enim ad minima veniam, quis nostrum
                        ...
                        <a href="{{ url('app-emailread') }}">
                            <div class="d-md-flex align-items-center email-message px-3 py-1">
                                ...
                                <div class="">
                                    <p class="mb-0">Excepteur sint occaecat cupidatat non proident, sunt
                                        in culpa...</p>
                                </div>
                                <div class="ms-auto">
                        ...
                        <a href="{{ url('app-emailread') }}">
                            <div class="d-md-flex align-items-center email-message px-3 py-1 bg-body">
                                ...
                                <div class="">
                                    <p class="mb-0">Nor again is there anyone who loves or pursues or
                                        desires to obtain
                                        pain...</p>
                                </div>
                                <div class="ms-auto">
                        ...
                        <a href="{{ url('app-emailread') }}">
                            <div class="d-md-flex align-items-center email-message px-3 py-1">
                                ...
                                <div class="">
                                    <p class="mb-0">All the Lorem Ipsum generators on the Internet tend
                                        to repeat
                                        predefined...</p>
                                </div>
                                <div class="ms-auto">
                        ...
                        <a href="{{ url('app-emailread') }}">
                            <div class="d-md-flex align-items-center email-message px-3 py-1">
                                ...
                                <div class="">
                                    <p class="mb-0">Content here, content here', making it look like
                                        readable English...
                                    </p>
                                </div>
                                <div class="ms-auto">
                        ...
                        <a href="{{ url('app-emailread') }}">
                            <div class="d-md-flex align-items-center email-message px-3 py-1">
                                ...
                                <div class="">
                                    <p class="mb-0">Various versions have evolved over the years,
                                        sometimes by
                                        accident...</p>
                                </div>
                                <div class="ms-auto">
                        ...
                        <a href="{{ url('app-emailread') }}">
                            <div class="d-md-flex align-items-center email-message px-3 py-1 bg-body">
                                ...
                                <div class="">
                                    <p class="mb-0">Business it will frequently occur that pleasures
                                        have to be
                                        repudiated...</p>
                                </div>
                                <div class="ms-auto">
                        ...
                        <a href="{{ url('app-emailread') }}">
                            <div class="d-md-flex align-items-center email-message px-3 py-1">
                                ...
                                <div class="">
                                    <p class="mb-0">Temporibus autem quibusdam et aut officiis debitis
                                        aut rerum
                        ...
                        <a href="{{ url('app-emailread') }}">
                            <div class="d-md-flex align-items-center email-message px-3 py-1">
                                ...
                                <div class="">
                                    <p class="mb-0">Chunks as necessary, making this the first true
                                        generator on the
                                        Internet...</p>
                                </div>
                                <div class="ms-auto">
