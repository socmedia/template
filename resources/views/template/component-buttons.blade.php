                ...
                <div class="card radius-10">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row row-cols-auto g-3">
                            ...
                            <div class="col">
                                <button type="button"
                                    class="btn btn-outline-secondary px-5 radius-30">Secondary</button>
                            </div>
                            <div class="col">
                ...
                <div class="card radius-10">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row row-cols-auto g-3">
                            ...
                            <div class="col">
                                <button type="button"
                                    class="btn btn-outline-secondary px-5 rounded-0">Secondary</button>
                            </div>
                        </div>
                        <!--end row-->
                    </div>
                ...
                <div class="card radius-10">
                        ...
                        <div class="row row-cols-auto g-3">
                            <div class="col">
                                <button type="button" class="btn btn-primary px-5"><i
                                        class='bx bx-user mr-1'></i>Person</button>
                            </div>
                            <div class="col">
                                <button type="button" class="btn btn-danger px-5"><i
                                        class='bx bx-bookmark mr-1'></i>Bookmark</button>
                            </div>
                            <div class="col">
                                <button type="button" class="btn btn-success px-5"><i
                                        class='bx bx-home mr-1'></i>Home</button>
                            </div>
                            <div class="col">
                                <button type="button" class="btn btn-info px-5"><i
                                        class='bx bx-cloud-download mr-1'></i>Downloads</button>
                            </div>
                            <div class="col">
                                <button type="button" class="btn btn-warning px-5"><i
                                        class='bx bx-heart-circle mr-1'></i>Love</button>
                            </div>
                            <div class="col">
                            ...
                            <div class="col">
                                <button type="button" class="btn btn-secondary px-5"><i
                                        class='bx bx-comment mr-1'></i>Comments</button>
                            </div>
                            <div class="w-100 border-top"></div>

                            <div class="col">
                                <button type="button" class="btn btn-lg btn-primary px-5"><i
                                        class='bx bx-user mr-1'></i>Person</button>
                            </div>
                            <div class="col">
                                <button type="button" class="btn btn-lg btn-danger px-5"><i
                                        class='bx bx-bookmark mr-1'></i>Bookmark</button>
                            </div>
                            <div class="col">
                                <button type="button" class="btn btn-lg btn-success px-5"><i
                                        class='bx bx-home mr-1'></i>Home</button>
                            </div>
                            <div class="w-100 border-top"></div>
                            ...
                            <div class="col">
                                <button type="button" class="btn btn-sm btn-danger px-5"><i
                                        class='bx bx-bookmark mr-1'></i>Bookmark</button>
                            </div>
                            <div class="col">
                                <button type="button" class="btn btn-sm btn-success px-5"><i
                                        class='bx bx-home mr-1'></i>Home</button>
                            </div>
                        </div>
                        <!--end row-->
                    ...
                    <div class="card-body">
                        ...
                        <div class="row row-cols-auto g-3">
                            ...
                            <div class="col">
                                <button type="button" class="btn btn-lg btn-outline-primary px-5"><i
                                        class='bx bx-user mr-1'></i>Person</button>
                            </div>
                            <div class="col">
                                <button type="button" class="btn btn-lg btn-outline-danger px-5"><i
                                        class='bx bx-bookmark mr-1'></i>Bookmark</button>
                            </div>
                            <div class="col">
                                <button type="button" class="btn btn-lg btn-outline-success px-5"><i
                                        class='bx bx-home mr-1'></i>Home</button>
                            </div>
                            <div class="w-100 border-top"></div>

                            <div class="col">
                                <button type="button" class="btn btn-sm btn-outline-primary px-5"><i
                                        class='bx bx-user mr-1'></i>Person</button>
                            </div>
                            <div class="col">
                                <button type="button" class="btn btn-sm btn-outline-danger px-5"><i
                                        class='bx bx-bookmark mr-1'></i>Bookmark</button>
                            </div>
                            <div class="col">
                                <button type="button" class="btn btn-sm btn-outline-success px-5"><i
                                        class='bx bx-home mr-1'></i>Home</button>
                            </div>
                        </div>
                        <!--end row-->
                    ...
                    <div class="card-body">
                        <div class="row row-cols-auto g-3">
                            <div class="col">
                                <button type="button" class="btn btn-outline-primary px-5 radius-30"><i
                                        class='bx bx-user mr-1'></i>Person</button>
                            </div>
                            <div class="col">
                                <button type="button" class="btn btn-outline-danger px-5 radius-30"><i
                                        class='bx bx-bookmark mr-1'></i>Bookmark</button>
                            </div>
                            <div class="col">
                            ...
                            <div class="col">
                                <button type="button" class="btn btn-outline-info px-5 radius-30"><i
                                        class='bx bx-cloud-download mr-1'></i>Downloads</button>
                            </div>
                            <div class="col">
                                <button type="button" class="btn btn-outline-warning px-5 radius-30"><i
                                        class='bx bx-heart-circle mr-1'></i>Love</button>
                            </div>
                            <div class="col">
                                <button type="button" class="btn btn-outline-dark px-5 radius-30"><i
                                        class='bx bx-cloud-upload mr-1'></i>Upload</button>
                            </div>
                            <div class="col">
                                <button type="button" class="btn btn-outline-secondary px-5 radius-30"><i
                                        class='bx bx-comment mr-1'></i>Comments</button>
                            </div>
                            ...
                            <div class="col">
                                <button type="button" class="btn btn-outline-secondary"><i
                                        class='bx bx-comment-detail me-0'></i>
                                </button>
                            </div>
                        </div>
                        <!--end row-->
                            ...
                            <div class="col">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <button type="button" class="btn btn-secondary"><i
                                            class='bx bx-cloud-light-rain me-0'></i>
                                    </button>
                                </div>
                            </div>
                            <div class="w-100 border-top"></div>
                            ...
                            <div class="col">
                                <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                                    <button type="button" class="btn btn-info"><i
                                            class='bx bxl-facebook-square me-0'></i>
                                    </button>
                                    <button type="button" class="btn btn-info"><i class='bx bxl-twitter me-0'></i>
                                    </button>
                                    <button type="button" class="btn btn-info"><i
                                            class='bx bxl-linkedin-square me-0'></i>
                                    </button>
                            ...
                            <div class="col">
                                <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                                    ...
                                    <button type="button" class="btn btn-dark"><i
                                            class='bx bx-video-recording me-0'></i>
                                    </button>
                        ...
                        <div class="row row-cols-auto g-3">
                            ...
                            <div class="col">
                                <div class="btn-group">
                                    ...
                                    <button type="button"
                                        class="btn btn-danger split-bg-danger dropdown-toggle dropdown-toggle-split"
                                        data-bs-toggle="dropdown" aria-expanded="false"> <span
                                            class="visually-hidden">Toggle Dropdown</span>
                                    </button>
                                    <ul class="dropdown-menu">
