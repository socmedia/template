                        ...
                        <div class="row row-cols-auto g-3">
                            <div class="col">
                                ...
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal">Basic modal</button>
                                <!-- Modal -->
                            ...
                            <div class="col">
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#exampleVerticallycenteredModal">Vertically Centered</button>
                                <!-- Modal -->
                            ...
                            <div class="col">
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#exampleLargeModal">Large Modal</button>
                                <!-- Modal -->
                            ...
                            <div class="col">
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#exampleSmallModal">Small Modal</button>
                                <!-- Modal -->
                            ...
                            <div class="col">
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#exampleFullScreenModal">Full Screen Modal</button>
                                <!-- Modal -->
                        ...
                        <div class="row row-cols-auto g-3">
                            <div class="col">
                                ...
                                <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                    data-bs-target="#exampleDangerModal">Danger Modal</button>
                                <!-- Modal -->
                            ...
                            <div class="col">
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#examplePrimaryModal">Primary Modal</button>
                                <!-- Modal -->
                            ...
                            <div class="col">
                                ...
                                <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                    data-bs-target="#exampleWarningModal">Warning Modal</button>
                                <!-- Modal -->
                            ...
                            <div class="col">
                                ...
                                <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                    data-bs-target="#exampleSuccessModal">Success Modal</button>
                                <!-- Modal -->
                            ...
                            <div class="col">
                                ...
                                <button type="button" class="btn btn-dark" data-bs-toggle="modal"
                                    data-bs-target="#exampleDarkModal">Dark Modal</button>
                                <!-- Modal -->
