...
@push("style")
<link href="{{ asset('assets/app/plugins/smart-wizard/css/smart_wizard_all.min.css') }}" rel="stylesheet"
    type="text/css" />
@endpush
                    ...
                    <div class="card-body">
                        ...
                        <div id="smartwizard">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="step-3" class="tab-pane" role="tabpanel" aria-labelledby="step-3">Lorem Ipsum
...
@push("script")
<script src="{{ asset('assets/app/plugins/smart-wizard/js/jquery.smartWizard.min.js') }}"></script>
<script>
