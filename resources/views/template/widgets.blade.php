                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                ...
                                <p class="mb-0 font-13 text-success"><i class='bx bxs-up-arrow align-middle'></i>$24
                                    from last week</p>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                ...
                                <p class="mb-0 font-13 text-danger"><i class='bx bxs-down-arrow align-middle'></i>$34
                                    from last week</p>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                ...
                                <p class="mb-0 font-13 text-danger"><i class='bx bxs-down-arrow align-middle'></i>12.2%
                                    from last week</p>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                ...
                                <p class="mb-0 font-13 text-dark"><i class="bx bxs-down-arrow align-middle"></i>12.2%
                                    from last week</p>
                            </div>
...
@section("script")
@parent
<script src="{{ asset('assets/app/plugins/apexcharts-bundle/js/apexcharts.min.js')  }}"></script>
<script src="{{ asset('assets/app/js/widgets.js')  }}"></script>
@endsection
