        ...
        <div class="card">
            <div class="row g-0">
                <div class="col-md-4 border-end">
                    <img src="{{ asset('assets/app/images/products/13.png') }}" class="img-fluid" alt="...">
                    <div class="row mb-3 row-cols-auto g-2 justify-content-center mt-3">
                        <div class="col"><img src="{{ asset('assets/app/images/products/12.png') }}" width="70"
                                class="border rounded cursor-pointer" alt=""></div>
                        <div class="col"><img src="{{ asset('assets/app/images/products/11.png') }}" width="70"
                                class="border rounded cursor-pointer" alt=""></div>
                        <div class="col"><img src="{{ asset('assets/app/images/products/14.png') }}" width="70"
                                class="border rounded cursor-pointer" alt=""></div>
                        <div class="col"><img src="{{ asset('assets/app/images/products/15.png') }}" width="70"
                                class="border rounded cursor-pointer" alt=""></div>
                    </div>
                </div>
                <div class="col-md-8">
        ...
        <div class="row row-cols-1 row-cols-lg-3">
            <div class="col">
                <div class="card">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="{{ asset('assets/app/images/products/16.png') }}" class="img-fluid" alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="col">
                <div class="card">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="{{ asset('assets/app/images/products/17.png') }}" class="img-fluid" alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="col">
                <div class="card">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="{{ asset('assets/app/images/products/19.png') }}" class="img-fluid" alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
