...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 row-cols-xl-4">
            <div class="col">
                <div class="card border-primary border-bottom border-3 border-0">
                    <img src="{{ asset('assets/app/images/gallery/01.png') }}" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card border-danger border-bottom border-3 border-0">
                    <img src="{{ asset('assets/app/images/gallery/02.png') }}" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card border-success border-bottom border-3 border-0">
                    <img src="{{ asset('assets/app/images/gallery/03.png') }}" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card border-warning border-bottom border-3 border-0">
                    <img src="{{ asset('assets/app/images/gallery/04.png') }}" class="card-img-top" alt="...">
                    <div class="card-body">
        ...
        <div class="row row-cols-1 row-cols-md-1 row-cols-lg-3 row-cols-xl-3">
            <div class="col">
                <div class="card">
                    <img src="{{ asset('assets/app/images/gallery/05.png') }}" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card">
                    <img src="{{ asset('assets/app/images/gallery/06.png') }}" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of
                            the card's content.</p>
            ...
            <div class="col">
                <div class="card">
                    <img src="{{ asset('assets/app/images/gallery/07.png') }}" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of
                            the card's content.</p>
        ...
        <div class="row row-cols-1 row-cols-md-1 row-cols-lg-3 row-cols-xl-3">
            <div class="col d-flex">
                <div class="card bg-danger w-100">
                    <img src="{{ asset('assets/app/images/gallery/35.png') }}" class="card-img-top" alt="...">
            ...
            <div class="col d-flex">
                <div class="card bg-success w-100">
                    <img src="{{ asset('assets/app/images/gallery/36.png') }}" class="card-img-top" alt="...">
                    <div class="card-body text-white">
                        <h5 class="card-title text-white">Card Sample Title</h5>
            ...
            <div class="col d-flex">
                <div class="card bg-warning w-100">
                    <img src="{{ asset('assets/app/images/gallery/37.png') }}" class="card-img-top" alt="...">
                    <div class="card-body text-white">
                        <h5 class="card-title text-white">Card Sample Title</h5>
                        <p class="card-text">This is a wider card with supporting text below as a natural lead-in to
        ...
        <div class="row row-cols-1 row-cols-md-1 row-cols-lg-2 row-cols-xl-2">
            <div class="col">
                <div class="card mb-3">
                    <img src="{{ asset('assets/app/images/gallery/08.png') }}" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">This is a wider card with supporting text below as a natural lead-in to
                            additional content. This content is a little bit longer.</p>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <img src="{{ asset('assets/app/images/gallery/09.png') }}" class="card-img-bottom" alt="...">
                </div>
            </div>
        </div>
        <!--end row-->
        ...
        <div class="row row-cols-1 row-cols-md-1 row-cols-lg-2 row-cols-xl-2">
            <div class="col">
                <div class="card">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="{{ asset('assets/app/images/gallery/10.png') }}" alt="..." class="card-img">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title">Card title</h5>
            ...
            <div class="col">
                <div class="card">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="{{ asset('assets/app/images/gallery/11.png') }}" alt="..." class="card-img">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title">Card title</h5>
        ...
        <div class="row row-cols-1 row-cols-md-1 row-cols-lg-2 row-cols-xl-2">
            <div class="col">
                <div class="card bg-dark text-white">
                    <img src="{{ asset('assets/app/images/gallery/12.png') }}" class="card-img" alt="...">
            ...
            <div class="col">
                <div class="card bg-dark text-white">
                    <img src="{{ asset('assets/app/images/gallery/13.png') }}" class="card-img" alt="...">
                    <div class="card-img-overlay">
                        <h5 class="card-title text-white">Card title</h5>
                        <p class="card-text">This is a wider card with supporting text below as a natural lead-in to
                            additional content. This content is a little bit longer.</p>
        ...
        <div class="card-group shadow">
            <div class="card border-end shadow-none">
                <img src="{{ asset('assets/app/images/gallery/14.png') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to
                        additional content. This content is a little bit longer.</p>
            ...
            <div class="card border-end shadow-none">
                <img src="{{ asset('assets/app/images/gallery/15.png') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to
                        additional content. This content is a little bit longer.</p>
            ...
            <div class="card shadow-none">
                <img src="{{ asset('assets/app/images/gallery/16.png') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to
                        additional content. This content is a little bit longer.</p>
